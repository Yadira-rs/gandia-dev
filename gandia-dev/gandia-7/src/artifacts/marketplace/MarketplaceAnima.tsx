    ...
    <div className="fixed inset-0 z-50 flex flex-col bg-[#fafaf9] dark:bg-[#0c0a09]">
      ...
      <div className="flex items-center justify-between px-6 py-3 border-b border-stone-200/70 dark:border-stone-800 shrink-0">
        <div className="flex items-center gap-3">
          ...
          <p className="text-[13px] font-semibold text-stone-800 dark:text-stone-100">Ecosistema Gandia</p>
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        {tab === 'soluciones' && (
          <aside className="w-56 shrink-0 border-r border-stone-200/70 dark:border-stone-800 flex flex-col overflow-y-auto [&::-webkit-scrollbar]:w-[4px] [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:bg-stone-200 dark:[&::-webkit-scrollbar-thumb]:bg-stone-700 [&::-webkit-scrollbar-thumb]:rounded-full bg-white dark:bg-[#1c1917]">
