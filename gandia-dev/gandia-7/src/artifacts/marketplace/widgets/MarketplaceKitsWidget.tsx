    ...
    <div className="flex flex-col gap-3 w-full">
      ...
      <div className="flex gap-1.5 flex-wrap overflow-x-auto pb-0.5">
        <button
          ...
          className={`px-2.5 py-1 rounded-full text-[10.5px] font-medium transition-all border cursor-pointer ${!necesidad
        ...
        {NECESIDADES.map((n: { id: string; label: string; tags: string[] }) => (
          <button
            ...
            className={`px-2.5 py-1 rounded-full text-[10.5px] font-medium transition-all border cursor-pointer ${necesidad === n.tags[0]
