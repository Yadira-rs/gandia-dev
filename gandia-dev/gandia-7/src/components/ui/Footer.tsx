...
const SOCIAL_LINKS = [
  {
    name: 'Instagram',
    url: 'https://instagram.com/gandia7',
              ...
              <div className="flex items-center gap-1.5 flex-wrap">
                {SOCIAL_LINKS.map((social) => (
                  <a
                    ...
                    className="group w-8 h-8 rounded-lg border flex items-center justify-center transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#2FAF8F] focus-visible:ring-offset-1"
                    style={{
                      borderColor: isDark ? '#242424' : '#E8E8E6',
                    }}
                    onMouseEnter={e => {
                  ...
                  >
                    <svg
                      className="w-3.5 h-3.5 transition-colors duration-200 group-hover:text-[#2FAF8F]"
                      viewBox="0 0 24 24"
                      fill="currentColor"
                      aria-hidden="true"
